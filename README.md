...
| **-** | Scene Showcase: SceneManager + Input + Assets + SoundManager + SaveData framework demo (Boot → Title / Menu / Settings / Game / Pause / SaveLoad) with BGM, SE, a 3-slider volume settings page, and 3-slot save with continue/load |
